...
class UserProfile(models.Model):
    ...
    Attributes:
        ...
        is_healthcare_provider  (django.db.models.DateTimeField)    : clinician enabled to play specialistic role
    """
    USER_TYPES = (
        ('AD', _('ADMINISTRATIVE')),
        ('TE', _('TECHNICAL')),
    ...
    # TODO: move these info to demographics (that is the place to store demographics info in...)
    # birth_date
    # birth_place
    # gender
    # phone
    ...
    numeric_password = models.CharField(max_length=4, null=True, blank=True, verbose_name=_('Numeric password'), help_text=_('4 numbers'))
    ...
    user_type = models.CharField(_('Type user'), choices=USER_TYPES, max_length=2)
    ...
    is_healthcare_provider = models.BooleanField(_('Is healthcare provider?'), default=True) # If user is healthcare provider it can play the specialistic role
